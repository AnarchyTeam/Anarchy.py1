...
["u350cc7408cc6cc82e056ee046131f925"] #Luffy
Amid = ki.getProfile().mid 
["uec09c371e4c19ae01aa3d84857440eb7"] #Zorro
Bmid = kk.getProfile().mid 
["ub23ad49c409ac6773c4a151114e4761c"] #Sanji
Cmid = kc.getProfile().mid 
["ueb040473fd4f50aa0b2ca56aee818b1d"] #Ussop
Dmid = ks.getProfile().mid 
["uce7a0da7850e53de4452cfe4535084e2"] #Chooper
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,"u350cc7408cc6cc82e056ee046131f925","uec09c371e4c19ae01aa3d84857440eb7","ub23ad49c409ac6773c4a151114e4761c","ueb040473fd4f50aa0b2ca56aee818b1d","uce7a0da7850e53de4452cfe4535084e2"]
induk=[mid,"u350cc7408cc6cc82e056ee046131f925"]
Creator=["u350cc7408cc6cc82e056ee046131f925","u350cc7408cc6cc82e056ee046131f925"]
admin=["u350cc7408cc6cc82e056ee046131f925","uec09c371e4c19ae01aa3d84857440eb7","ub23ad49c409ac6773c4a151114e4761c","ueb040473fd4f50aa0b2ca56aee818b1d","uce7a0da7850e53de4452cfe4535084e2"]
owner=["u350cc7408cc6cc82e056ee046131f925","uec09c371e4c19ae01aa3d84857440eb7"]
wait = {
    'contact':False,
    'autoJoin':True,
...
Idline: http://line.me/ti/p/88BONDS""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ By😊\n☆º°team ɮօt killers ✰☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by KrisBABANG__ADHI⭐👈 »»» http://line.me/ti/p/boy29putra «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["One piece","Kr asup","Masuk"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Kabur all","Balik"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Kabur","Pulang"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#---------------------Sc invite owner ke group------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Yang Manis Kalem :BABANG_ADHI\nNama : ADHI\nZodiak :Pisces")
      #-------------Fungsi Chat ----------------
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰BONDSTEAMKILLERS⭐👈 »»» http://line.me/ti/p/88BONDS«««")
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰>>>BONDSTEAMKILLER «««")
                    kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰BONDSTEAMKILLERS »»» http://line.me/ti/p/88BONDS «««")
                    kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€  ✰😊\n\n☆º°˚˚☆BONDSTEAMKILLER »»» http://line.me/ti/p/88BONDS «««")
                    ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By BONDSTEAMKILLERS »»» http://line.me/ti/p/88BONDS «««")
                    print "Like"
                except:
                    pass
            else:
