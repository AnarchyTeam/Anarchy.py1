...
print "��􀸂􀅞└Babang adhi✗┐�􀸂􀅠∆�"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage ="""TEAM BOT ADHI
...
-==================-
"""
Keyowner ="""TEAM BOT ADHI
Owner :��􀸂􀅞└Babang adhi✗┐�􀸂􀅠∆�
-==================-
◄]-=Menu For Owner=-[►
[•]Kick ...
[•]Invite (by mid)
[•]Jepit Jones(Invite user by kontak)
[•]Adminlist
[•]Bot Add @
[•]Spam... (contoh spam on 10 tes)
[•]Daftar jomblo (cek kontak bot)
...
induk=["u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32"]
Creator=["u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32"]
admin=["u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32","u0548e577b8d144d19d36617941d15062","ub23ad49c409ac6773c4a151114e4761c","uf44a92c0c62be1ff5a7e7a73758aad4f","ub51bc97c5e4f603f1dff35e9512550d3"]
owner=["u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32"]
wait = {
    'contact':False,
    'autoJoin':True,
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              random.choice(KAC).sendText(op.param1, "Mau ngapain kak?\nKk Bukan Admin\nJadi Aku Cancel😛")
...
#===========================================
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "||Admin ��􀸂􀅞└Babang adhi✗┐�􀸂􀅠∆�\n=====================\n"
                  for mi_d in admin or Bots:
                   ...
                   if txt[1] == "on":
                        if jmlh <= 10000:
                         ...
                         if jmlh <= 10000:
                               ...
                               cl.sendText(msg.to, "Out of range! ")
    #-----------------=Selesai=------------------
            elif msg.text in ["Daftar jomblo"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
...
#====================================================
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "cuc2e8b426f6591045943eae5304e67c32',"}
                cl.sendMessage(msg)
#====================================================
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Dhi buka qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done Bossque")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Yank buka qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Yank")
                    else:
            ...
            elif msg.text in ["Dd buka qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done kak")
                    else:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Dhi tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Bosquu")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Yank tutup qr"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done Yank")
                    else:
...
#==================================================
            ...
            elif msg.text.lower() == 'dhi restart':
              if msg.from_ in admin:
...
#==========================================================================		
              ...
              if msg.from_ in admin:
				try:
					...
					pass
#============================================================
            elif msg.text in ["Jepit Jones"]:
              if msg.from_ in admin:
                 wait["winvite"] = True
                 cl.sendText(msg.to,"send kontak Jones")
#============================================================
...
#---------------------Sc invite owner ke group------
            elif "Asup: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Asup: ","")
                if gid == "":
...
#===============================================
#===============================================
            elif msg.text in ["Desah","Desah sayang"]:
              if msg.from_ in admin:
                cl.sendText(msg.to, "aaahhh aww yesss...")
                start = time.time()
                time.sleep(0.0001)
                ...
                if msg.from_ in admin:
                    cl.sendText(msg.to, "Progreess.....")
                    start = time.time()
                    time.sleep(0.0001)
                    elapsed_time = time.time() - start
                    cl.sendText(msg.to, "%sseconds" % (elapsed_time))
                    print "[Command]Speed palsu executed"				
            elif "ange" in msg.text:
                if msg.from_ in admin:
                    cl.sendText(msg.to, "Aww croott yank")
                    start = time.time()
                    time.sleep(0.02)
                    elapsed_time = time.time() - start
                    cl.sendText(msg.to, "%sseconds" % (elapsed_time))
                    print "[Command]Speed palsu executed"
            elif "Cocol" in msg.text:
                if msg.from_ in admin:
                    cl.sendText(msg.to, "aaahh cocol yaank..")
                    start = time.time()
                    time.sleep(0.001)
                    elapsed_time = time.time() - start
                    cl.sendText(msg.to, "%sseconds" % (elapsed_time))   
                    print "[Command]Speed palsu executed"
            elif "Dalemin" in msg.text:
                if msg.from_ in admin:
                    cl.sendText(msg.to, "awww...aah...")
                    start = time.time()
                    time.sleep(0.003)
                    elapsed_time = time.time() - start
                    cl.sendText(msg.to, "%sseconds" % (elapsed_time))  
                    print "[Command]Speed palsu executed"
            elif "Coli" in msg.text:
                if msg.from_ in admin:
                    time.sleep(0.2)
                    cl.sendText(msg.to, "aaahhh...")
                    start = time.time()
                    time.sleep(0.02)
                    elapsed_time = time.time() - start
                    cl.sendText(msg.to, "%sseconds" % (elapsed_time))     	
                    print "[Command]Speed palsu executed"
            elif msg.text in ["asli"]:
                if msg.from_ in admin:
                    start = time.time()
                    cl.sendText(msg.to, "Oke Bosque")
                    elapsed_time = time.time() - start
                    cl.sendText(msg.to, "%sseconds" % (elapsed_time))
...
#=================================================
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Cek jones sedang di proses......")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : ��􀸂􀅞└Babang adhi✗┐�􀸂􀅠∆�✰||\n\n>Pelaku CCTV<\n%s-=CCTV=-Moga jones akut\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Jones dulu Oneng\nBaru Ketik Diciduk\nDASAR jones ♪")

            elif msg.text == "Cctv":
              if msg.from_ in admin:
                    cl.sendText(msg.to, "siap intip si jones....")
                    try:
                        del wait2['readPoint'][msg.to]
                        del wait2['readMember'][msg.to]
                    except:
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print "[Command] Check"
                                chiya += rom[1] + "\n"
                        cl.sendText(msg.to, "✔ ��􀸂􀅞└Babang adhi✗┐�􀸂􀅠∆�\nRead : %s\n\n✖ Sider :\n%s\nPoint creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                        except:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Sayang","Sini"]: #Panggil Semua Bot
              if msg.from_ in admin:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Balik"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Pulang","Yuk pulang"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#--------------------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["aduh","duh"]:
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Siapp Bossquu...")
                elapsed_time = time.time() - start
...
#---------------------Sc invite owner ke group------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'uc2e8b426f6591045943eae5304e67c32'}
                cl.sendText(msg.to,"===============")
                cl.sendMessage(msg)
                cl.sendText(msg.to,"================")
                cl.sendText(msg.to,"ini creator saya kak...!!!")
      #-------------Fungsi Chat ----------------
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = ["uc2e8b426f6591045943eae5304e67c32"]
